...
{ 
	...
	public function registration()
	{
		...
		$this->form_validation->set_rules('nomor', 'Nomor', 'required|trim|numeric|is_unique[user.nomor]', [
			'is_unique' => 'Nomor HP ini sudah terdaftar',
			'numeric' => 'Kolom harus diisi dengan angka',
	...
	private function _sendEmail($token, $type)
	{
		...
		$config = [
			...
			'smtp_user' => 'kenkenryu63@gmail.com',
			'smtp_pass' => 'spesialone63',
			'smtp_port' => 465,
			'mailtype' 	=> 'html',
			'charset'	=> 'utf-8',
			'newline' 	=> "\r\n"
		...
		$this->email->from('kenkenryu63@gmail.com', 'Kyriz Ryu');
	...
	public function verify()
	{
		...
		if ($user) {
			...
			$this->session->set_flashdata('message',  '<div class="alert alert-danger" role="alert">Aktivasi akun gagal! Email invalid.</div>');
			redirect('auth');
	...
	public function kontak ()
	{
        ...
        else
        {
            ...
            $to_email = 'kenkenryu63@gmail.com';
